...
var mainState = {
  ...
  create: function() {
    ...
    // To actually add pipes in our game we need to call the addRowOfPipes() function every 1.5 seconds.
    this.timer = game.time.events.loop(1500, this.addRowOfPipes, this);

    // display the score on the upper left corner
    this.score = 0;
  ...
  update: function() {
    ...
    // also restart game on collision detection
